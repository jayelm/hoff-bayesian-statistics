...
So as $n$ grows large, the variance on $\tilde{Y}$ approaches the variance of
$\mathbb{E}$.
...
\begin{align}
p_{\theta}(\theta \mid n_0, t_0) &= p_{\phi}(h(\theta) \mid n_0, t_0) \times \| \frac{dh}{d\theta} \| \\
...
So the posterior is (not sure if you can do this?)
...
weights of the relative components are preserved (as in the Beta mixtures
above).
